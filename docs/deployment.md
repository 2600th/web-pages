...
3. Record the current known-good source revision and `gh-pages` deployment revision, and retain a recoverable copy of the generated deployment before replacing it.
