...
context: At Interior Company, part of Square Yards
disciplines: [Interior design technology, Real-time 3D, Workflow automation, Product leadership]
...
careerOrder: 160
relationships: [homelane-spacecraft-pro, designesto]
relatedWork: [designesto, propvr-ai-craft, homelane-spacecraft-pro]
evidenceStatus: approval-enhanced
publicClaims:
  - Blocks connects real-time interior design with product pricing and production information.
...
heroMedia:
  ...
  height: 900
sources:
  - label: Interior Company, Blocks design and production
    url: https://www.interiorcompany.com/
    type: official-source
  - label: Blocks public launch post
    url: https://www.linkedin.com/feed/update/urn:li:activity:7347844333657628673/
    type: authored-post
  - label: InCo AI and the Blocks integration
    url: https://www.linkedin.com/posts/pranshulchandhok_interiordesign-incoai-designtech-activity-7339171151543209984-m3Aw
    type: authored-post
seo:
...
[Designesto](/work/designesto/) develops the concept and revision side of this work. Blocks serves the structured design and operational side. The useful connection is the boundary between them: explore a direction, then resolve the measurable decisions needed to carry it forward.
