...
summary: A March 2023 essay connected language models, generative assets, NeRFs, AI animation, adaptive music, and in-engine tools into an early public view of AI-native production.
yearStart: 2023
status: Authored public thesis
...
A separate note will revisit which parts of the thesis held up, which became ordinary, and where the difficult product work moved next.
